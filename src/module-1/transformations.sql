...
FROM
  FINANCE.CYBERSYN.OECD_TIMESERIES oecd_timeseries
JOIN 
  FINANCE.CYBERSYN.OECD_ATTRIBUTES oecd_attributes
  ON oecd_timeseries.variable = oecd_attributes.variable
LEFT JOIN 
  FINANCE.CYBERSYN.BUREAU_OF_LABOR_STATISTICS_PRICE_TIMESERIES bureau_of_labor_statistics_price_timeseries
...
LEFT JOIN 
  FINANCE.CYBERSYN.BUREAU_OF_LABOR_STATISTICS_PRICE_ATTRIBUTES bureau_of_labor_statistics_price_attributes
